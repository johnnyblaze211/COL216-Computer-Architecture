...
int process()
{
    ...
    if(PC/I2B >=32768){
        ...
        if(ins.name == "add"){
            ...
            clock_cycles++;
            cout<<"Cycle number: "<<clock_cycles<<"\n";
            cout<<"Instruction: "<<ins.ins_str<<"\n";
            ...
            if(int_addr/256 == row_buffer_index){
              ...
              cout<<"Cycle number: "<<clock_cycles<<"\n";
              cout<<"Instruction: "<<ins.ins_str<<"\n";
              cout<<"Remarks: DRAM request to address "<<addr<<"(row "<<row_buffer_index<<")"<<", currently active row is also "<<row_buffer_index<<"\n";

              clock_cycles++;
              cout<<"Cycle number: "<<clock_cycles<<"-"<<clock_cycles + COL_ACCESS_DELAY - 1<<"\n";clock_cycles += (COL_ACCESS_DELAY - 1);
              cout<<"Instruction: DRAM Column Request"<<"\n";
              cout<<"Register: R"<<ins.dst_reg<<"="<<reg_file[ins.dst_reg]<<"\n";
              cout<<"Remarks: As the row is already in row buffer, activate and writeback time is avoided\n";
            }
              ...
              cout<<"Cycle number: "<<clock_cycles<<"\n";
              cout<<"Instruction: "<<ins.ins_str<<"\n";
              cout<<"Remarks: DRAM request to address "<<addr<<"(row "<<int_addr/256<<")"<<", currently no row is active."<<"\n";

              clock_cycles++;
              cout<<"Cycle number: "<<clock_cycles<<"-"<<clock_cycles + ROW_ACCESS_DELAY - 1<<"\n"; clock_cycles += (ROW_ACCESS_DELAY - 1);
              cout<<"Instruction: DRAM Activate row "<<int_addr/256<<"\n";
              cout<<"Remarks: Load row "<<int_addr/256<<" in row buffer\n";

              clock_cycles++;
              cout<<"Cycle number: "<<clock_cycles<<"-"<<clock_cycles + COL_ACCESS_DELAY - 1<<"\n";clock_cycles += (COL_ACCESS_DELAY - 1);
              cout<<"Instruction: DRAM Column Request"<<"\n";
              cout<<"Register: R"<<ins.dst_reg<<"="<<reg_file[ins.dst_reg]<<"\n";
              cout<<"Remarks: Column access and write value in R"<<ins.dst_reg<<"\n";
              ...
              cout<<"Cycle number: "<<clock_cycles<<"\n";
              cout<<"Instruction: "<<ins.ins_str<<"\n";
              cout<<"Remarks: DRAM request to address "<<addr<<"(row "<<int_addr/256<<")"<<"\n";

              clock_cycles++;
              cout<<"Cycle number: "<<clock_cycles<<"-"<<clock_cycles + ROW_ACCESS_DELAY - 1<<"\n"; clock_cycles += (ROW_ACCESS_DELAY - 1);
              cout<<"Instruction: DRAM writeback row "<<row_buffer_index<<"\n";
            ...
            if(int_addr / 256 == row_buffer_index){
              ...
              clock_cycles++;
              cout<<"Cycle number: "<<clock_cycles<<"-"<<clock_cycles + COL_ACCESS_DELAY - 1<<"\n";clock_cycles += (COL_ACCESS_DELAY - 1);
              cout<<"Instruction: DRAM Column Access"<<"\n";
              cout<<"Memory: Address "<<addr<<"="<<reg_file[ins.dst_reg]<<"\n";
              cout<<"Remarks: As the row is already in row buffer, activate and writeback time is avoided\n";
              mem.insert(addr);
            }
              ...
              cout<<"Instruction: DRAM Column Request"<<"\n";
              cout<<"Memory: Address "<<addr<<"="<<reg_file[ins.dst_reg]<<"\n";
              cout<<"Remarks: Column access and update memory"<<"\n";
              mem.insert(addr);
