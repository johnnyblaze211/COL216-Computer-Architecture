...
void tokenize(string s){
    ...
    // if(fun.size() > 0 && fun[fun.size()-1] == ':'){          // This is some function whose label needs to be stored
    //     ins.fun_label = strip(fun.substr(0,fun.size()-1));         // Assuming LO and lo represent 2 different functions
    //     if(ins.fun_label==""){flag=true;return;}
    //     label[ins.fun_label] = instr.size();
    //     instr.push_back(ins);
    //     tokenize(s.substr(i,s.size()-fun.size()));           // All labels are converted to the form
    //                                                     /*
    //                                                          label:
    //                                                                 ......       
    //                                                                 ......
